...
```
Project:      KitchenKit
Description:  Recipe manager + shift prep planner — Ratio Blueprint Engine, mise en place generation, prep list builder. Standalone for home cooks, caterers & personal chefs. Bridges into CulinaryOS via recipe-mcp 
Status:       planning
...
```
Language:     Detected: Node.js/TypeScript · pnpm monorepo · Turborepo
...
---
*Auto-generated: 2026-06-28 | Extends: ShadowWalkerNC/.github/AGENTS.md | Repo: [KitchenKit](https://github.com/ShadowWalkerNC/KitchenKit)*
